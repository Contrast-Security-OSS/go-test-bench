...
func NewSQLInjectionGetQueryExecParams() SQLInjectionGetQueryExecParams {
	...
	return SQLInjectionGetQueryExecParams{}
}

// SQLInjectionGetQueryExecParams contains all the bound params for the SQL injection get query exec operation
...
func (o *SQLInjectionGetQueryExecParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *SQLInjectionGetQueryExecParams) bindInput(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *SQLInjectionGetQueryExecParams) bindSafety(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *SQLInjectionGetQueryExecParams) validateSafety(formats strfmt.Registry) error {
