...
func NewCmdInjectionGetQueryCommandContextParams() CmdInjectionGetQueryCommandContextParams {
	...
	return CmdInjectionGetQueryCommandContextParams{}
}

// CmdInjectionGetQueryCommandContextParams contains all the bound params for the cmd injection get query command context operation
// typically these are obtained from a http.Request
//
// swagger:parameters CmdInjectionGetQueryCommandContext
type CmdInjectionGetQueryCommandContextParams struct {
...
func (o *CmdInjectionGetQueryCommandContextParams) bindInput(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *CmdInjectionGetQueryCommandContextParams) bindSafety(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CmdInjectionGetQueryCommandContextParams) validateSafety(formats strfmt.Registry) error {
