...
type CmdInjectionGetQueryCommandContextURL struct {
	Safety string
...
func (o *CmdInjectionGetQueryCommandContextURL) Build() (*url.URL, error) {
	...
	if safety != "" {
		...
		return nil, errors.New("safety is required on CmdInjectionGetQueryCommandContextURL")
	}
...
func (o *CmdInjectionGetQueryCommandContextURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on CmdInjectionGetQueryCommandContextURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on CmdInjectionGetQueryCommandContextURL")
	}
