...
func NewPathTraversalGetQueryCreateParams() PathTraversalGetQueryCreateParams {
	...
	return PathTraversalGetQueryCreateParams{}
}

// PathTraversalGetQueryCreateParams contains all the bound params for the path traversal get query create operation
...
func (o *PathTraversalGetQueryCreateParams) bindInput(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *PathTraversalGetQueryCreateParams) bindSafety(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PathTraversalGetQueryCreateParams) validateSafety(formats strfmt.Registry) error {
