...
func (o *PathTraversalGetQueryWriteFileURL) Build() (*url.URL, error) {
	...
	if safety != "" {
		...
		return nil, errors.New("safety is required on PathTraversalGetQueryWriteFileURL")
	}
...
func (o *PathTraversalGetQueryWriteFileURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on PathTraversalGetQueryWriteFileURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on PathTraversalGetQueryWriteFileURL")
	}
