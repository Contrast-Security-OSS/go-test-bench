...
func NewPathTraversalGetBufferedQueryOpenParams() PathTraversalGetBufferedQueryOpenParams {
	...
	return PathTraversalGetBufferedQueryOpenParams{}
}
...
func (o *PathTraversalGetBufferedQueryOpenParams) bindInput(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *PathTraversalGetBufferedQueryOpenParams) bindSafety(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PathTraversalGetBufferedQueryOpenParams) validateSafety(formats strfmt.Registry) error {
