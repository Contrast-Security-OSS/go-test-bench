...
func NewPathTraversalGetQueryWriteFileParams() PathTraversalGetQueryWriteFileParams {
	...
	return PathTraversalGetQueryWriteFileParams{}
}

// PathTraversalGetQueryWriteFileParams contains all the bound params for the path traversal get query write file operation
...
func (o *PathTraversalGetQueryWriteFileParams) bindInput(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *PathTraversalGetQueryWriteFileParams) bindSafety(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PathTraversalGetQueryWriteFileParams) validateSafety(formats strfmt.Registry) error {
