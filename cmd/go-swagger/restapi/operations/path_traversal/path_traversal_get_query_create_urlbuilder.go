...
func (o *PathTraversalGetQueryCreateURL) Build() (*url.URL, error) {
	...
	if safety != "" {
		...
		return nil, errors.New("safety is required on PathTraversalGetQueryCreateURL")
	}
...
func (o *PathTraversalGetQueryCreateURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on PathTraversalGetQueryCreateURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on PathTraversalGetQueryCreateURL")
	}
