...
func NewPathTraversalGetBufferedQueryCreateParams() PathTraversalGetBufferedQueryCreateParams {
	...
	return PathTraversalGetBufferedQueryCreateParams{}
}
...
func (o *PathTraversalGetBufferedQueryCreateParams) bindInput(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *PathTraversalGetBufferedQueryCreateParams) bindSafety(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PathTraversalGetBufferedQueryCreateParams) validateSafety(formats strfmt.Registry) error {
