...
func (o *PathTraversalGetBufferedQueryCreateURL) Build() (*url.URL, error) {
	...
	if safety != "" {
		...
		return nil, errors.New("safety is required on PathTraversalGetBufferedQueryCreateURL")
	}
...
func (o *PathTraversalGetBufferedQueryCreateURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on PathTraversalGetBufferedQueryCreateURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on PathTraversalGetBufferedQueryCreateURL")
	}
