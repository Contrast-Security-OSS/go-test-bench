...
func NewPathTraversalGetBufferedQueryReadFileParams() PathTraversalGetBufferedQueryReadFileParams {
	...
	return PathTraversalGetBufferedQueryReadFileParams{}
}
...
func (o *PathTraversalGetBufferedQueryReadFileParams) bindInput(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *PathTraversalGetBufferedQueryReadFileParams) bindSafety(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PathTraversalGetBufferedQueryReadFileParams) validateSafety(formats strfmt.Registry) error {
