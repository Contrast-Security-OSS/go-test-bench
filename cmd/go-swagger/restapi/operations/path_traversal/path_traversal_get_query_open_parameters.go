...
func NewPathTraversalGetQueryOpenParams() PathTraversalGetQueryOpenParams {
	...
	return PathTraversalGetQueryOpenParams{}
}

// PathTraversalGetQueryOpenParams contains all the bound params for the path traversal get query open operation
...
func (o *PathTraversalGetQueryOpenParams) bindInput(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *PathTraversalGetQueryOpenParams) bindSafety(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PathTraversalGetQueryOpenParams) validateSafety(formats strfmt.Registry) error {
