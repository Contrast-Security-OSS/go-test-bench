...
func NewPathTraversalGetBufferedQueryWriteFileParams() PathTraversalGetBufferedQueryWriteFileParams {
	...
	return PathTraversalGetBufferedQueryWriteFileParams{}
}

// PathTraversalGetBufferedQueryWriteFileParams contains all the bound params for the path traversal get buffered query write file operation
// typically these are obtained from a http.Request
//
// swagger:parameters PathTraversalGetBuffered-QueryWriteFile
...
func (o *PathTraversalGetBufferedQueryWriteFileParams) bindInput(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *PathTraversalGetBufferedQueryWriteFileParams) bindSafety(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PathTraversalGetBufferedQueryWriteFileParams) validateSafety(formats strfmt.Registry) error {
