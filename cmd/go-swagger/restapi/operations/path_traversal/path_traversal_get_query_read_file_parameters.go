...
func NewPathTraversalGetQueryReadFileParams() PathTraversalGetQueryReadFileParams {
	...
	return PathTraversalGetQueryReadFileParams{}
}

// PathTraversalGetQueryReadFileParams contains all the bound params for the path traversal get query read file operation
...
func (o *PathTraversalGetQueryReadFileParams) bindInput(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *PathTraversalGetQueryReadFileParams) bindSafety(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PathTraversalGetQueryReadFileParams) validateSafety(formats strfmt.Registry) error {
